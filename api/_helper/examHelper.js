...
exports.averageScore = async (scoreDetails) => {
  ...
  let total_canditions = scoreDetails.length;
  ...
  let first_round_average = (first_round_total / total_canditions).toFixed(2);
  let second_round_average = (second_round_total / total_canditions).toFixed(2);
  let third_round_average = (third_round_total / total_canditions).toFixed(2);
